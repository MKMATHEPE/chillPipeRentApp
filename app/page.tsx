...
export default function Home() {
  ...
  function submit(event: React.FormEvent) {
    ...
    localStorage.setItem('chill-pipe-order', JSON.stringify({ quantities, selectedFlavours, delivery, customer, total }));
  ...
  return <main>
    <header className="site-header"><a className="brand" href="#top" aria-label="The Chill Pipe home"><img src="/chill-pipe-logo.png" alt="The Chill Pipe" /></a><nav className="main-nav" aria-label="Main navigation"><a className="active" href="/">Book</a><a href="/how-it-works">How it works</a><a href="/terms">Terms</a></nav><div className="header-note"><span className="pulse" /> Taking rental requests</div></header>
